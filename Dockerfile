...
COPY zulu*.tar.gz jdk.tgz
RUN tar -zxf jdk.tgz && mv zulu* zulu && rm jdk.tgz && chmod u+s zulu/lib/amd64/criu
...
# CMD java -Zcheckpoint -cp app:app/lib/* com.azul.helper.CRMain com.example.ServerApplication
CMD java -Zcheckpoint -cp app:app/lib/* com.azul.helper.CRMain org.springframework.samples.petclinic.PetClinicApplication
